...
func TestHealth(t *testing.T) {
	...
	if player.health > player.maxHealth {
		t.Fatalf("Health is more than threshold! Current: %v, max: %v", player.health, player.maxHealth)
	}
...
func TestEnergy(t *testing.T) {
	...
	if player.energy > player.maxEnergy {
		t.Fatalf("Energy is more than threshold! Current: %v, max: %v", player.energy, player.maxEnergy)
	}
